...
ThemeData light = ThemeData(
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF006241))),
  colorScheme: const ColorScheme.light(primary: Color(0xFF006241), secondary: Color(0xFF006241)).copyWith(error: const Color(0xFFE84D4F)),
